...
Imp #1	But sir! We've been tormenting like this for millennia. It's hand-crafted suffering!	13		Imps/2.ogg
Imp #1	We provide artisan, small-batch damnation!	13		Imps/4.ogg
...
Satan	IIIIMPS, GET TO WORK!	31		Devil Open/13.ogg
Imps	Yes, sir!	33		Imps/5.ogg""".split("\n")
